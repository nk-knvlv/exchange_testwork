...
Например: если ты претендуешь на должность front-end разработчика и не знаком с python, то ты можешь написать только [клиентскую часть](#web-terminal), 
а в местах **работы с WebSocket API** ставить заглушки; писать серверную часть на javascript **не нужно**. 
...
### <a id="web-terminal"></a> Торговый терминал (клиент)
